...
bool checkHeightBalanced(node* root) {
	...
	// 1. check if the leftSubtree is heightBalanced -> friend
	bool X = checkHeightBalanced(root->left);

	// 2. check if the rightSubtree is heightBalanced -> friend
...
Pair checkHeightBalancedEfficient(node* root) {
	...
	// 1. check if the leftSubtree is heightBalanced & simultaneously compute the height of the leftSubtree
	Pair pL = checkHeightBalancedEfficient(root->left);

	// 2. check if the rightSubtree is heightBalanced & simulataneously compute the height of the rightSubtree
